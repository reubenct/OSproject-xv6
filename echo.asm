...
main(int argc, char *argv[])
{
  ...
  20:	c7 44 24 0c 9e 07 00 	movl   $0x79e,0xc(%esp)
  27:	00 
  28:	8b 44 9f fc          	mov    -0x4(%edi,%ebx,4),%eax
  2c:	c7 44 24 04 a0 07 00 	movl   $0x7a0,0x4(%esp)
  33:	00 
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3c9:	0f b6 92 ae 07 00 00 	movzbl 0x7ae(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 55f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 561:	b8 a7 07 00 00       	mov    $0x7a7,%eax
...
00000620 <free>:
 620:	55                   	push   %ebp
 621:	a1 40 0a 00 00       	mov    0xa40,%eax
 ...
 679:	a3 40 0a 00 00       	mov    %eax,0xa40
 67e:	5b                   	pop    %ebx
 67f:	5e                   	pop    %esi
 680:	5f                   	pop    %edi
 681:	5d                   	pop    %ebp
 ...
 69d:	a3 40 0a 00 00       	mov    %eax,0xa40
...
000006b0 <malloc>:
 ...
 6bc:	8b 15 40 0a 00 00    	mov    0xa40,%edx
 ...
 711:	39 05 40 0a 00 00    	cmp    %eax,0xa40
 ...
 73b:	8b 15 40 0a 00 00    	mov    0xa40,%edx
 ...
 75f:	89 15 40 0a 00 00    	mov    %edx,0xa40
 ...
 776:	c7 05 40 0a 00 00 44 	movl   $0xa44,0xa40
 77d:	0a 00 00 
 780:	c7 05 44 0a 00 00 44 	movl   $0xa44,0xa44
 787:	0a 00 00 
 78a:	b8 44 0a 00 00       	mov    $0xa44,%eax
 78f:	c7 05 48 0a 00 00 00 	movl   $0x0,0xa48
 796:	00 00 00 
