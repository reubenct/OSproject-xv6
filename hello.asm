...
main(int argc, char *argv[])
{
 ...
 int i;
  ...
  2b:	7e 42                	jle    6f <main+0x6f>
  2d:	bb 01 00 00 00       	mov    $0x1,%ebx
  32:	eb 1c                	jmp    50 <main+0x50>
  34:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    printf(1, "%s%s", argv[i], i+1 < argc ? " " : "\n");
  38:	68 55 07 00 00       	push   $0x755
  3d:	ff 74 9f fc          	pushl  -0x4(%edi,%ebx,4)
  41:	68 57 07 00 00       	push   $0x757
  46:	6a 01                	push   $0x1
  ...
  57:	68 5c 07 00 00       	push   $0x75c
  5c:	ff 74 b7 fc          	pushl  -0x4(%edi,%esi,4)
  60:	68 57 07 00 00       	push   $0x757
  65:	6a 01                	push   $0x1
  67:	e8 c4 03 00 00       	call   430 <printf>
...
putc(int fd, char c)
{
 ...
 548:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 54b:	b8 5e 07 00 00       	mov    $0x75e,%eax
