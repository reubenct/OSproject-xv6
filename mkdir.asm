...
main(int argc, char *argv[])
{
  ...
  25:	e8 00 03 00 00       	call   32a <mkdir>
  ...
  exit();
  38:	e8 85 02 00 00       	call   2c2 <exit>
    exit();
  }
  ...
  3f:	c7 44 24 04 b5 07 00 	movl   $0x7b5,0x4(%esp)
  46:	00 
...
main(int argc, char *argv[])
{
  ...
  if(argc < 2){
    printf(2, "Usage: mkdir files...\n");
  59:	c7 44 24 04 9e 07 00 	movl   $0x79e,0x4(%esp)
  60:	00 
  61:	c7 04 24 02 00 00 00 	movl   $0x2,(%esp)
  68:	e8 c3 03 00 00       	call   430 <printf>
    exit();
  6d:	e8 50 02 00 00       	call   2c2 <exit>
  72:	66 90                	xchg   %ax,%ax
  74:	66 90                	xchg   %ax,%ax
  76:	66 90                	xchg   %ax,%ax
  78:	66 90                	xchg   %ax,%ax
...
putc(int fd, char c)
{
 ...
 55f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 561:	b8 d1 07 00 00       	mov    $0x7d1,%eax
...
00000620 <free>:
 ...
 69d:	a3 70 0a 00 00       	mov    %eax,0xa70
...
000006b0 <malloc>:
 ...
 711:	39 05 70 0a 00 00    	cmp    %eax,0xa70
 ...
 73b:	8b 15 70 0a 00 00    	mov    0xa70,%edx
 ...
 75f:	89 15 70 0a 00 00    	mov    %edx,0xa70
 ...
 776:	c7 05 70 0a 00 00 74 	movl   $0xa74,0xa70
 77d:	0a 00 00 
 780:	c7 05 74 0a 00 00 74 	movl   $0xa74,0xa74
 787:	0a 00 00 
 78a:	b8 74 0a 00 00       	mov    $0xa74,%eax
 78f:	c7 05 78 0a 00 00 00 	movl   $0x0,0xa78
 796:	00 00 00 
