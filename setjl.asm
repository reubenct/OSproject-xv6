...
int main(int argc, char *argv[]){
  ...
  2e:	e8 1d 02 00 00       	call   250 <atoi>
  33:	89 74 24 04          	mov    %esi,0x4(%esp)
  37:	89 04 24             	mov    %eax,(%esp)
  3a:	e8 33 03 00 00       	call   372 <signalinfo>
	exit();
  3f:	e8 7e 02 00 00       	call   2c2 <exit>
#include "user.h"
int main(int argc, char *argv[]){
	...
	{
	 printf(1,"\n ! Error: number of argument lesser than required\n");
  44:	c7 44 24 04 a0 07 00 	movl   $0x7a0,0x4(%esp)
  4b:	00 
  4c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  53:	e8 d8 03 00 00       	call   430 <printf>
	 exit();
  58:	e8 65 02 00 00       	call   2c2 <exit>
	 }
	else if(argc>3)
	 printf(1,"\n (! Error: 3rd argument neglected\n)"); 
  5d:	c7 44 24 04 d4 07 00 	movl   $0x7d4,0x4(%esp)
  64:	00 
  65:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  6c:	e8 bf 03 00 00       	call   430 <printf>
  71:	eb a8                	jmp    1b <main+0x1b>
  73:	66 90                	xchg   %ax,%ax
  75:	66 90                	xchg   %ax,%ax
  77:	66 90                	xchg   %ax,%ax
  79:	66 90                	xchg   %ax,%ax
...
{
  write(fd, &c, 1);
 476:	e8 67 fe ff ff       	call   2e2 <write>
...
putc(int fd, char c)
{
 ...
 4e6:	e8 f7 fd ff ff       	call   2e2 <write>
      } else if(c == '%'){
        putc(fd, c);
      } else {
        // Unknown % sequence.  Print it to draw attention.
...
putc(int fd, char c)
{
 ...
 610:	e8 cd fc ff ff       	call   2e2 <write>
          putc(fd, *s);
          s++;
        }
      } else if(c == 'c'){
...
00000620 <free>:
 ...
 679:	a3 94 0a 00 00       	mov    %eax,0xa94
 67e:	5b                   	pop    %ebx
 67f:	5e                   	pop    %esi
 680:	5f                   	pop    %edi
 681:	5d                   	pop    %ebp
 ...
 69d:	a3 94 0a 00 00       	mov    %eax,0xa94
...
000006b0 <malloc>:
 ...
 711:	39 05 94 0a 00 00    	cmp    %eax,0xa94
 ...
 73b:	8b 15 94 0a 00 00    	mov    0xa94,%edx
 ...
 75f:	89 15 94 0a 00 00    	mov    %edx,0xa94
 ...
 776:	c7 05 94 0a 00 00 98 	movl   $0xa98,0xa94
 77d:	0a 00 00 
 780:	c7 05 98 0a 00 00 98 	movl   $0xa98,0xa98
 787:	0a 00 00 
 78a:	b8 98 0a 00 00       	mov    $0xa98,%eax
 78f:	c7 05 9c 0a 00 00 00 	movl   $0x0,0xa9c
 796:	00 00 00 
