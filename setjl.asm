...
int main(int argc, char *argv[]){
  ...
  3a:	56                   	push   %esi
  3b:	50                   	push   %eax
  3c:	e8 21 03 00 00       	call   362 <signalinfo>
	exit();
...
int main(int argc, char *argv[]){
  ...
  59:	56                   	push   %esi
  5a:	56                   	push   %esi
  5b:	68 74 07 00 00       	push   $0x774
  60:	6a 01                	push   $0x1
  62:	e8 b9 03 00 00       	call   420 <printf>
  67:	83 c4 10             	add    $0x10,%esp
  6a:	eb b6                	jmp    22 <main+0x22>
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3bf:	f7 f6                	div    %esi
 3c1:	0f b6 92 a4 07 00 00 	movzbl 0x7a4(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 538:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 53b:	b8 9c 07 00 00       	mov    $0x79c,%eax
...
free(void *ap)
{
 ...
 5c1:	a1 44 0a 00 00       	mov    0xa44,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 617:	89 08                	mov    %ecx,(%eax)
  freep = p;
 619:	a3 44 0a 00 00       	mov    %eax,0xa44
}
 61e:	5b                   	pop    %ebx
 61f:	5e                   	pop    %esi
 620:	5f                   	pop    %edi
 ...
 63a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 63d:	a3 44 0a 00 00       	mov    %eax,0xa44
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 659:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 65c:	8b 15 44 0a 00 00    	mov    0xa44,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6fc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6ff:	89 15 44 0a 00 00    	mov    %edx,0xa44
      return (void*)(p + 1);
 ...
 714:	eb e9                	jmp    6ff <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 716:	c7 05 44 0a 00 00 48 	movl   $0xa48,0xa44
 71d:	0a 00 00 
 720:	c7 05 48 0a 00 00 48 	movl   $0xa48,0xa48
 727:	0a 00 00 
    base.s.size = 0;
 72a:	b8 48 0a 00 00       	mov    $0xa48,%eax
 72f:	c7 05 4c 0a 00 00 00 	movl   $0x0,0xa4c
 736:	00 00 00 
