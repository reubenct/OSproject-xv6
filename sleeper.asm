...
int main(int argc, char *argv[]){
  ...
  2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
		n= (n* 10 + ( argv[1][i] - '0' ));
  30:	8d 1c 89             	lea    (%ecx,%ecx,4),%ebx
  33:	0f be 0a             	movsbl (%edx),%ecx
...
int main(int argc, char *argv[]){
  ...
  39:	39 d0                	cmp    %edx,%eax
		n= (n* 10 + ( argv[1][i] - '0' ));
  3b:	8d 4c 59 d0          	lea    -0x30(%ecx,%ebx,2),%ecx
#include "types.h"
#include "user.h"
int main(int argc, char *argv[]){
	int n=0,i,len=0;
  ...
  41:	69 c9 e8 03 00 00    	imul   $0x3e8,%ecx,%ecx
  47:	ba 89 88 88 88       	mov    $0x88888889,%edx
  4c:	83 ec 0c             	sub    $0xc,%esp
  4f:	89 c8                	mov    %ecx,%eax
  51:	f7 ea                	imul   %edx
  53:	01 ca                	add    %ecx,%edx
  55:	c1 f9 1f             	sar    $0x1f,%ecx
  58:	c1 fa 03             	sar    $0x3,%edx
  5b:	29 ca                	sub    %ecx,%edx
  5d:	52                   	push   %edx
  5e:	e8 df 02 00 00       	call   342 <sleep>
	exit();
  63:	e8 4a 02 00 00       	call   2b2 <exit>
#include "types.h"
#include "user.h"
int main(int argc, char *argv[]){
	int n=0,i,len=0;
  68:	31 c9                	xor    %ecx,%ecx
  6a:	eb d5                	jmp    41 <main+0x41>
  6c:	66 90                	xchg   %ax,%ax
  6e:	66 90                	xchg   %ax,%ax
...
free(void *ap)
{
 ...
 5f7:	89 08                	mov    %ecx,(%eax)
  freep = p;
 5f9:	a3 c4 09 00 00       	mov    %eax,0x9c4
}
 5fe:	5b                   	pop    %ebx
 5ff:	5e                   	pop    %esi
 600:	5f                   	pop    %edi
 ...
 61a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 61d:	a3 c4 09 00 00       	mov    %eax,0x9c4
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 639:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 63c:	8b 15 c4 09 00 00    	mov    0x9c4,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 68f:	76 3f                	jbe    6d0 <malloc+0xa0>
    ...
    if(p == freep)
 691:	39 05 c4 09 00 00    	cmp    %eax,0x9c4
 ...
 6b6:	e8 e5 fe ff ff       	call   5a0 <free>
  return freep;
 6bb:	8b 15 c4 09 00 00    	mov    0x9c4,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 6df:	89 15 c4 09 00 00    	mov    %edx,0x9c4
      return (void*)(p + 1);
 ...
 6f4:	eb e9                	jmp    6df <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 6f6:	c7 05 c4 09 00 00 c8 	movl   $0x9c8,0x9c4
 6fd:	09 00 00 
 700:	c7 05 c8 09 00 00 c8 	movl   $0x9c8,0x9c8
 707:	09 00 00 
    base.s.size = 0;
 70a:	b8 c8 09 00 00       	mov    $0x9c8,%eax
 70f:	c7 05 cc 09 00 00 00 	movl   $0x0,0x9cc
 716:	00 00 00 
