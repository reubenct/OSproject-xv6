...
int main(int argc, char *argv[]){
  ...
  56:	e8 e7 02 00 00       	call   342 <sleep>
	exit();
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b9:	0f b6 92 95 07 00 00 	movzbl 0x795(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 54f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 551:	b8 8e 07 00 00       	mov    $0x78e,%eax
...
00000610 <free>:
 610:	55                   	push   %ebp
 611:	a1 28 0a 00 00       	mov    0xa28,%eax
 ...
 669:	a3 28 0a 00 00       	mov    %eax,0xa28
 66e:	5b                   	pop    %ebx
 66f:	5e                   	pop    %esi
 670:	5f                   	pop    %edi
 671:	5d                   	pop    %ebp
 ...
 68d:	a3 28 0a 00 00       	mov    %eax,0xa28
...
000006a0 <malloc>:
 ...
 701:	39 05 28 0a 00 00    	cmp    %eax,0xa28
 ...
 72b:	8b 15 28 0a 00 00    	mov    0xa28,%edx
 ...
 74f:	89 15 28 0a 00 00    	mov    %edx,0xa28
 ...
 766:	c7 05 28 0a 00 00 2c 	movl   $0xa2c,0xa28
 76d:	0a 00 00 
 770:	c7 05 2c 0a 00 00 2c 	movl   $0xa2c,0xa2c
 777:	0a 00 00 
 77a:	b8 2c 0a 00 00       	mov    $0xa2c,%eax
 77f:	c7 05 30 0a 00 00 00 	movl   $0x0,0xa30
 786:	00 00 00 
