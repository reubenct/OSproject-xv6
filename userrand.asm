...
_userrand:     file format elf32-i386
...
00000000 <main>:
  ...
  18:	e8 d3 00 00 00       	call   f0 <strlen>
  1d:	83 c4 10             	add    $0x10,%esp
  20:	85 c0                	test   %eax,%eax
  22:	7e 3c                	jle    60 <main+0x60>
  24:	8b 53 04             	mov    0x4(%ebx),%edx
  27:	31 db                	xor    %ebx,%ebx
  29:	01 d0                	add    %edx,%eax
  2b:	90                   	nop
  2c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  30:	0f be 0a             	movsbl (%edx),%ecx
  33:	8d 1c 9b             	lea    (%ebx,%ebx,4),%ebx
  36:	83 c2 01             	add    $0x1,%edx
  39:	39 d0                	cmp    %edx,%eax
  3b:	8d 5c 59 d0          	lea    -0x30(%ecx,%ebx,2),%ebx
  3f:	75 ef                	jne    30 <main+0x30>
  41:	83 ec 0c             	sub    $0xc,%esp
  44:	53                   	push   %ebx
  45:	e8 08 03 00 00       	call   352 <random>
  4a:	53                   	push   %ebx
  4b:	50                   	push   %eax
  4c:	68 8e 07 00 00       	push   $0x78e
  51:	6a 01                	push   $0x1
  53:	e8 c8 03 00 00       	call   420 <printf>
  58:	83 c4 20             	add    $0x20,%esp
  5b:	e8 52 02 00 00       	call   2b2 <exit>
  60:	31 db                	xor    %ebx,%ebx
  62:	eb dd                	jmp    41 <main+0x41>
  64:	66 90                	xchg   %ax,%ax
  66:	66 90                	xchg   %ax,%ax
  68:	66 90                	xchg   %ax,%ax
  6a:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3b9:	0f b6 92 a7 07 00 00 	movzbl 0x7a7(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 54f:	8b 38                	mov    (%eax),%edi
        ...
        if(s == 0)
          s = "(null)";
 551:	b8 a0 07 00 00       	mov    $0x7a0,%eax
...
00000610 <free>:
 610:	55                   	push   %ebp
 611:	a1 40 0a 00 00       	mov    0xa40,%eax
 ...
 669:	a3 40 0a 00 00       	mov    %eax,0xa40
 66e:	5b                   	pop    %ebx
 66f:	5e                   	pop    %esi
 670:	5f                   	pop    %edi
 671:	5d                   	pop    %ebp
 ...
 68d:	a3 40 0a 00 00       	mov    %eax,0xa40
...
000006a0 <malloc>:
 ...
 6ac:	8b 15 40 0a 00 00    	mov    0xa40,%edx
 ...
 701:	39 05 40 0a 00 00    	cmp    %eax,0xa40
 ...
 72b:	8b 15 40 0a 00 00    	mov    0xa40,%edx
 ...
 74f:	89 15 40 0a 00 00    	mov    %edx,0xa40
 ...
 766:	c7 05 40 0a 00 00 44 	movl   $0xa44,0xa40
 76d:	0a 00 00 
 770:	c7 05 44 0a 00 00 44 	movl   $0xa44,0xa44
 777:	0a 00 00 
 77a:	b8 44 0a 00 00       	mov    $0xa44,%eax
 77f:	c7 05 48 0a 00 00 00 	movl   $0x0,0xa48
 786:	00 00 00 
